...
public class OTUnitProjectAdapter extends
        RecyclerView.Adapter<OTUnitProjectAdapter.ItemViewHolder>
    ...
    public OTUnitProjectAdapter(ArrayList<ReportData> otResponse, Context context, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder itemViewHolder, final int position) {
        try {
            ...
            setPieData(mFilteredList.get(position).getNotStarted().intValue(),
                    ...
                    mFilteredList.get(position).getTotal().intValue(),
                    itemViewHolder);
