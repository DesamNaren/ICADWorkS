...
public class StrucutureBaseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.structure_dashboard_fragment, container, false);
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new OTStructureFragment();
                case 1:
                    return new CDStructureFragment();
            }
            return null;
        }
