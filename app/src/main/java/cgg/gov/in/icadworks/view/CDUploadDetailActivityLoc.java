...
public class CDUploadDetailActivityLoc extends LocBaseActivity implements UpdateOTView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uplolad_cd_detail);
        ...
        try {
            ...
            String cdDataStr = sharedPreferences.getString("ITEM_DATA_FIN", "");
            checkDamData = gson.fromJson(cdDataStr, CheckDamData.class);
        ...
        switch (requestCode) {
            case REQUEST_WRITE_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(CDUploadDetailActivityLoc.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
...
//        startActivityForResult(intent, PHOTO_REQUEST);
    ...
    public Uri getOutputMediaFileUri(int type) {
        ...
        Uri imageUri = FileProvider.getUriForFile(
                CDUploadDetailActivityLoc.this,
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.imageIV:
                ActivityCompat.requestPermissions(CDUploadDetailActivityLoc.this, new
