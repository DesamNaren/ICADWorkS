...
public class LocBaseFragment extends Fragment {
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            ...
                            flag = false;
                            Utilities.showSettingsAlert(getActivity(), getString(R.string.loc), true);

                        }
                        else if (report.getDeniedPermissionResponses().size() > 0) {
                            flag = false;
                            showPermissionsAlert(LocBaseFragment.this, getString(R.string.loc), true);
                        }
    ...
    private void showPermissionsAlert(final LocBaseFragment activity, String string, final boolean flag) {
