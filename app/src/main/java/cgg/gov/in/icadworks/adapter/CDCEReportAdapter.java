...
public class CDCEReportAdapter extends RecyclerView.Adapter<CDCEReportAdapter.ItemViewHolder> implements Filterable {
    ...
    public CDCEReportAdapter(CDOfficeResponse cdOfficeResponse, ArrayList<CDOfficeData> cdOfficeDataArrayList, Context context, Activity activity) {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (CDOfficeData cdOfficeData : cdOfficeDataArrayList) {
                        if (cdOfficeData.getOfficeName().toLowerCase().contains(charString.toLowerCase())) {
