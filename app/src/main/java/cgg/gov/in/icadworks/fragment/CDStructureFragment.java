...
import cgg.gov.in.icadworks.adapter.CDDashboardAdapter;
...
public class CDStructureFragment extends Fragment implements OTView {
    ...
    private CDDashboardAdapter CDDashboardAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.cd_structure_fragment, container, false);
        pos = 0;
        ...
        switchView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Gson gson = new Gson();
                    List<CheckDamData> checkDamData = CDDashboardAdapter.getFilteredData();
            ...
            public void onClick(View view) {
                try {
                    ...
                    if(!TextUtils.isEmpty(notStCount.getText().toString()) && Integer.valueOf(notStCount.getText().toString())>0){
                        ...
                        CDDashboardAdapter.setFilteredData(null);
    ...
    private void search(SearchView searchView) {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                try {
                    if (CDDashboardAdapter != null) {
                        CDDashboardAdapter.getFilter().filter(newText);
                        List<CheckDamData> checkDamData = CDDashboardAdapter.getFilteredData();
    ...
    void setDataAdapter(CheckDamResponse checkDamResponse) {
        flagSwitch = "list";
        CDDashboardAdapter = new CDDashboardAdapter(checkDamResponse.getData(), getActivity());
        dashboardRV.setLayoutManager(new LinearLayoutManager(getActivity()));
        dashboardRV.setAdapter(CDDashboardAdapter);
    }
...
//                        }
    ...
    void setDataAdapterOT(ArrayList<CheckDamData> checkDamData) {
        ...
        searchView.setIconified(true);
        flagSwitch = "list";
        CDDashboardAdapter = new CDDashboardAdapter(checkDamData, getActivity());
        dashboardRV.setLayoutManager(new LinearLayoutManager(getActivity()));
        dashboardRV.setAdapter(CDDashboardAdapter);
        CDDashboardAdapter.setFilteredData(checkDamData);
    }
