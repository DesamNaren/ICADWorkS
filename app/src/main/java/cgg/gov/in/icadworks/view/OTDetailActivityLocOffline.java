...
public class OTDetailActivityLocOffline extends LocBaseActivity {
    OTData otData;
    ...
    public void onViewClicked() {
        ...
        if (ConnectionDetector.isConnectedToInternet(this)) {
            ...
            if (mCurrentLocation != null && mCurrentLocation.getLatitude() > 0 && mCurrentLocation.getLongitude() > 0) {
                ...
                navigateToUpdateActivity("offline");
            }
        } else {
            navigateToUpdateActivity("offline");
//            Utilities.showCustomNetworkAlert(this, getResources().getString(R.string.no_internet), false);
    ...
    private void navigateToUpdateActivity(String str) {
        if (str.equalsIgnoreCase("online")) {
            ...
            editor.putString("STO_TYPE", str);
            editor.commit();

            startActivity(new Intent(OTDetailActivityLocOffline.this, UploadDetailActivityLoc.class));
        } else {
            Gson gson = new Gson();
            String otDataStr = gson.toJson(otData);

            Utilities.showOfflineNetworkAlert(this, "You are not within the 100 meter radius of selected OT, Please upload status photo from gallery",
                    otDataStr, foundationVal, superStrVal, shutterVal, foundationTextVal, superTextVal, shutterTextVal, false);
        }
    }
    ...
    private void displayDialogBox(String photo) {
        final Dialog dialog = new Dialog(OTDetailActivityLocOffline.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
        ...
        Picasso.with(OTDetailActivityLocOffline.this).load(photo)
